...
@Component({
    ...
    imports: [RouterOutlet, HomeComponent, SidebarComponent, AboutComponent, IntroductionComponent, ResumeComponent, ServicesComponent, SkillsComponent, ContactComponent, MenubarComponent]
})
